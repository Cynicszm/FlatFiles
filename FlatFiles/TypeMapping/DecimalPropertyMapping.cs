...
{
    internal sealed class DecimalPropertyMapping(DecimalColumn column, IMemberAccessor member, int physicalIndex, int logicalIndex) : IDecimalPropertyMapping, IMemberMapping
    {
