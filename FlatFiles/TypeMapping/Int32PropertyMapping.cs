...
{
    internal sealed class Int32PropertyMapping(Int32Column column, IMemberAccessor member, int physicalIndex, int logicalIndex) : IInt32PropertyMapping, IMemberMapping
    {
