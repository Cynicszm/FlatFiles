...
namespace FlatFiles.TypeMapping
{
        ...
        IMapperSource<TEntity>
    {
        ...
        {
            var mapping = lookup.GetOrAddMember( member, ( physicalIndex, logicalIndex ) => new DelimitedComplexPropertyMapping<TProp>( mapper, member, physicalIndex, logicalIndex ) );
            windowLookup[mapping] = window;
            return mapping;
        }
        ...
        {
            var mapping = lookup.GetOrAddMember( member, ( physicalIndex, logicalIndex ) => new FixedLengthComplexPropertyMapping<TProp>( mapper, member, physicalIndex, logicalIndex ) );
            windowLookup[mapping] = window;
            return mapping;
        }
