...
namespace FlatFiles.TypeMapping
{
    ...
    public interface IGuidPropertyMapping
    {
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IGuidPropertyMapping Nullable(bool isNullable);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IGuidPropertyMapping OnParsed(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IGuidPropertyMapping OnFormatting(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IGuidPropertyMapping OnFormatted(Func<IColumnContext?, string, string?>? handler);
    }
}
