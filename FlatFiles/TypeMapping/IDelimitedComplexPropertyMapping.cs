...
namespace FlatFiles.TypeMapping
{
    ...
    /// </summary>
    public interface IDelimitedComplexPropertyMapping
    {
        /// <summary>
        ...
        IDelimitedComplexPropertyMapping ColumnName(string name);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDelimitedComplexPropertyMapping WithOptions(DelimitedOptions? options);
        ...
        IDelimitedComplexPropertyMapping NullFormatter(INullFormatter formatter);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDelimitedComplexPropertyMapping OnParsing(Func<IColumnContext?, string, string?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDelimitedComplexPropertyMapping OnParsed(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDelimitedComplexPropertyMapping OnFormatting(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDelimitedComplexPropertyMapping OnFormatted(Func<IColumnContext?, string, string?>? handler);
    }
}
