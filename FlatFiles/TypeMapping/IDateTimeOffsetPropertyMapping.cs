...
namespace FlatFiles.TypeMapping
{
    ...
    public interface IDateTimeOffsetPropertyMapping
    {
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDateTimeOffsetPropertyMapping Nullable(bool isNullable);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDateTimeOffsetPropertyMapping OnParsing(Func<IColumnContext?, string, string?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDateTimeOffsetPropertyMapping OnParsed(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDateTimeOffsetPropertyMapping OnFormatting(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IDateTimeOffsetPropertyMapping OnFormatted(Func<IColumnContext?, string, string?>? handler);
    }
}
