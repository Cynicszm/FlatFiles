...
{
    internal sealed class DateTimeOffsetPropertyMapping(DateTimeOffsetColumn column, IMemberAccessor member, int physicalIndex, int logicalIndex) : IDateTimeOffsetPropertyMapping, IMemberMapping
    {
        ...
        public IDateTimeOffsetPropertyMapping Nullable(bool isNullable)
        {
