...
namespace FlatFiles.TypeMapping
{
    ...
    /// </summary>
    public interface IDynamicDelimitedTypeConfiguration
    {
        /// <summary>
        ...
        /// <param name="memberName">The name of the property to map.</param>
        /// <returns>An object to configure the property mapping.</returns>
        IDateOnlyPropertyMapping DateOnlyProperty( string memberName );
        ...
        /// <param name="memberName">The name of the property to map.</param>
        /// <returns>An object to configure the property mapping.</returns>
        ITimeOnlyPropertyMapping TimeOnlyProperty( string memberName );
        ...
        /// <returns>An object to configure the property mapping.</returns>
        IDelimitedComplexPropertyMapping ComplexProperty<TProp>( string memberName, IDelimitedTypeMapper<TProp> mapper );
