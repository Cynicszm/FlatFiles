...
{
    internal sealed class Int64PropertyMapping(Int64Column column, IMemberAccessor member, int physicalIndex, int logicalIndex) : IInt64PropertyMapping, IMemberMapping
    {
        ...
        public IInt64PropertyMapping Nullable(bool isNullable)
        {
