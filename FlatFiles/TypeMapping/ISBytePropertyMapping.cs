...
namespace FlatFiles.TypeMapping
{
    ...
    public interface ISBytePropertyMapping
    {
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ISBytePropertyMapping Nullable(bool isNullable);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ISBytePropertyMapping OnParsing(Func<IColumnContext?, string, string?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ISBytePropertyMapping OnParsed(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ISBytePropertyMapping OnFormatting(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ISBytePropertyMapping OnFormatted(Func<IColumnContext?, string, string?>? handler);
    }
}
