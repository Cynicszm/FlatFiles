...
{
    internal sealed class SinglePropertyMapping(SingleColumn column, IMemberAccessor member, int physicalIndex, int logicalIndex) : ISinglePropertyMapping, IMemberMapping
    {
        ...
        public ISinglePropertyMapping Nullable(bool isNullable)
        {
