...
{
    internal sealed class BooleanPropertyMapping(BooleanColumn column, IMemberAccessor member, int physicalIndex, int logicalIndex) : IBooleanPropertyMapping, IMemberMapping
    {
