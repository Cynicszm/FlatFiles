...
{
    internal sealed class CharPropertyMapping(CharColumn column, IMemberAccessor member, int physicalIndex, int logicalIndex) : ICharPropertyMapping, IMemberMapping
    {
