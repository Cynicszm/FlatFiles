...
{
    internal sealed class BytePropertyMapping(ByteColumn column, IMemberAccessor member, int physicalIndex, int logicalIndex) : IBytePropertyMapping, IMemberMapping
    {
