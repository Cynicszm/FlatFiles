...
namespace FlatFiles.TypeMapping
{
    ...
    public interface IDynamicDelimitedTypeMapper : IDynamicDelimitedTypeConfiguration
    {
        ...
        /// </remarks>
        IAsyncEnumerable<object> ReadAsync( TextReader reader, DelimitedOptions? options, CancellationToken cancellationToken )
        {
        ...
        ///     cancellation; an implementation that can should override it.
        /// </remarks>
        Task WriteAsync( TextWriter writer, IEnumerable<object> entities, DelimitedOptions? options, CancellationToken cancellationToken )
        {
        ...
        ///     cancellation; an implementation that can should override it.
        /// </remarks>
        Task WriteAsync( TextWriter writer, IAsyncEnumerable<object> entities, DelimitedOptions? options, CancellationToken cancellationToken )
        {
            return WriteAsync( writer, entities, options );
        }
