...
namespace FlatFiles.TypeMapping
{
    ...
    public interface ICharArrayPropertyMapping
    {
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ICharArrayPropertyMapping Nullable(bool isNullable);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ICharArrayPropertyMapping OnParsing(Func<IColumnContext?, string, string?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ICharArrayPropertyMapping OnParsed(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ICharArrayPropertyMapping OnFormatting(Func<IColumnContext?, object?, object?>? handler);
        ...
        /// <returns>The property mapping for further configuration.</returns>
        ICharArrayPropertyMapping OnFormatted(Func<IColumnContext?, string, string?>? handler);
    }
}
