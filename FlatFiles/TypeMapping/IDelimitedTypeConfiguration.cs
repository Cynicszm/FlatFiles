...
namespace FlatFiles.TypeMapping
{
    ...
    public interface IDelimitedTypeConfiguration<TEntity>
    {
        /// <summary>
        ///     Gets the schema defined by the current configuration.
        /// </summary>
        /// <returns>The schema.</returns>
        DelimitedSchema GetSchema();
        ...
        /// <param name="accessor">An expression that returns the property to map.</param>
        /// <returns>An object to configure the property mapping.</returns>
        IDateOnlyPropertyMapping Property( Expression<Func<TEntity, DateOnly>> accessor );
        ...
        /// <param name="accessor">An expression that returns the property to map.</param>
        /// <returns>An object to configure the property mapping.</returns>
        ITimeOnlyPropertyMapping Property( Expression<Func<TEntity, TimeOnly>> accessor );
        ...
        /// <returns>An object to configure the property mapping.</returns>
        IDelimitedComplexPropertyMapping ComplexProperty<TProp>( Expression<Func<TEntity, TProp>> accessor, IDelimitedTypeMapper<TProp> mapper );
