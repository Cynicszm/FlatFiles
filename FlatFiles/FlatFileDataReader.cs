...
namespace FlatFiles
{
    ...
    public sealed class FlatFileDataReader : IDataReader, IFlatFileDataRecord
    {
        ...
        {
            return GetValue<DateTimeOffset>( i );
        }
