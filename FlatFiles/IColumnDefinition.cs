...
namespace FlatFiles
{
    ...
    public interface IColumnDefinition
    {
        ...
        /// <summary>
        ///     Formats the given object and appends the result to a buffer instead of returning a string. Writers use
        ///     this to format a whole record without allocating a string per value; the default writes the string
        ///     that <see cref="Format(IColumnContext?, object?)" /> returns.
        /// </summary>
        /// <param name="context">Holds information about the column current being processed.</param>
        /// <param name="value">The object to format.</param>
        /// <param name="destination">The buffer to append the formatted value to.</param>
        void Format( IColumnContext? context, object? value, IBufferWriter<char> destination )
        {
