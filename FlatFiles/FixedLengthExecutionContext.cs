namespace FlatFiles
{
    internal sealed class FixedLengthExecutionContext( FixedLengthSchema schema, FixedLengthOptions options ) : ExecutionContextBase, IFixedLengthExecutionContext
    {
